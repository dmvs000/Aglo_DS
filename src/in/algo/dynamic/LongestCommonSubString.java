...
public class LongestCommonSubString {
	...
	static void LongestCommonoSubStringSpaceOptimized(String str1, String str2) {
		int m = str1.length();
		int n = str2.length();
		int[] dp_ref = new int[n];
		int maxLen = 0;
		int startingIndex = 0;
		for (int i = m - 1; i >= 0; i--) {
			int[] dp = new int[n];
		...
		System.out.println("Len of Common SubString 		: " + maxLen);
		System.out.println("Starting Index of the SubString : " + startingIndex);
	}
	...
	public static void main(String[] args) {
		...
		LongestCommonoSubStringSpaceOptimized(str1, str2);
	}
