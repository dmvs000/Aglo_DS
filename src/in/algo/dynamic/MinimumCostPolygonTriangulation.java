...
public class MinimumCostPolygonTriangulation {
	...
	public static double calMinCost_DP(ArrayList<point> al) {
		...
		// If there are less than two values in al then no triangle or polygon
		// can be formed.
		// So the cost would be zero.
		// IF there are more than or equal to 3 points. We should split it
		// points by connecting first,k,end points. k varies from k+1 to end
		// (exclusive)
